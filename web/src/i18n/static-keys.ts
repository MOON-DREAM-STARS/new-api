...
export const STATIC_I18N_KEYS = [
  ...
  // Dreamstars Web Workspace keys retained during upstream synchronization.
  'Starting',
  'Running',
  'Idle',
  'Stopping',
  ...
  'Project was created but is not registered yet',
  'Refresh the project list and try again.',
  'Registering the created project...',
  ...
  'Clipboard content must be 8 MB or smaller.',
  'The remote clipboard format is not supported.',
  'The remote clipboard operation failed. Try again.',
  ...
  'The remote page could not open the selected project.',
] as const
